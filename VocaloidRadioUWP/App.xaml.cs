        ...
        private void MemoryManager_AppMemoryUsageIncreased(object sender, object e)
{
        ...
        {
            if (_isBackground && Window.Current.Content != null)
            {
        ...
        private static void SetTheme()
        {
            ...
            if (theme != null)
            {
                App.Current.RequestedTheme = EnumHelper.Parse<ApplicationTheme>(theme);
            }
        }
        ...
        private void CreateRootFrame(ApplicationExecutionState previousExecutionState, string arguments)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                rootFrame.Navigate(typeof(View.MainPage), arguments);
            }
        }
